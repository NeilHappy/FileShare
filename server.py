...
class AccessDenied(Fault):
    """
    An exeption that is raised if a user tries to access a resource for which he or she is not authorized.
    """
...
def inside(dir,name):   
    """
    Checks whether a given file anem lies within a given directory.
    """
    dir=abspath(dir)
    name=abspath(name)
...
def getPort(url):
    """
    Extracts the prot number from a URL.
    """
